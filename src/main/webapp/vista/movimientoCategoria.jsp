    ...
    <table class="table table-bordered">
        ...
        <fmt:formatDate value="${movimiento.getFecha()}" pattern="dd/MM/yyyy" var="fechaFormateada" />
                ...
                <tr>
                    ...
                    <td><a href="MovimientoController?ruta=eliminarMovimiento&idMovimiento=${movimiento.getId()}&tipoMovimiento=${movimiento.getMovimiento().getNombreTipo()}&idCuenta=${movimiento.getCuenta().getId()}&mesDado=${mesDado}&idCategoria=${movimiento.getCategoria().getId()}&tipoJSP=verPorCategoria">Eliminar</a></td>
