    ...
    <table class="table table-bordered">
        ...
        <c:forEach var="indice" begin="0" end="${movimientos.size()}" step="1">
            ...
            <fmt:formatDate value="${movimiento.getFecha()}" pattern="dd/MM/yyyy" var="fechaFormateada" />
                    ...
                    <td><a href="MovimientoController?ruta=eliminarMovimiento&idMovimiento=${movimiento.getId()}&tipoMovimiento=${movimiento.getMovimiento().getNombreTipo()}&idCuenta=${movimiento.getCuenta().getId()}&mesDado=${mesDado}&idCategoria=${movimiento.getCategoria().getId()}&tipoJSP=verPorCuenta">Eliminar</a></td>
                    </tr>
